...
<!-- formwork-init fills the three blocks below. Everything after them is universal. -->
...
**<TIER>** — see `formwork.config.json`. Tier decides which gates run and how hard review is.
...
| How is the code laid out? | `docs/architecture.md` (generated by `/formwork-map` — do not hand-edit) |
